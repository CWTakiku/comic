package com.example.cwl.common.glide;
...
public class ImageLoader {
     ...
     * @param useCache
     */
    public  void  loadImageView(Context mContext, String url, ImageView mImageView, boolean useCache){
        if (useCache){
     ...
     * @param imageView
     */
    public void loadLocalGif(Context context, int resId, ImageView imageView){
        Glide.with(context).asGif().load(resId).into(imageView);
    }
    public void loadNetGif(Context context, String url, ImageView imageView){
    ...
    public  void loadImageViewLoding(Context mContext, String url, ImageView mImageView, int placeImage) {
        RequestOptions options = new RequestOptions()
                .placeholder(placeImage);
        loadImageWithOptions(mContext,url,mImageView,options);
    }
